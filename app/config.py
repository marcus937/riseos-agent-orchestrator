...
def get_settings() -> Settings:
    ...
    hermes_slack_webhook_url = os.getenv("HERMES_SLACK_WEBHOOK_URL") or orchestrator_slack_webhook_url or legacy_slack_webhook_url
    ...
    return Settings(
        ...
        slack_webhook_url=hermes_slack_webhook_url or orchestrator_slack_webhook_url or legacy_slack_webhook_url,
